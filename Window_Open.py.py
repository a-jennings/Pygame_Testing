...
#Set variable pi for drawing arcs
pi=3.141592653

#Set font variable to add text to screen
font=pygame.font.Font("C:/Windows/Fonts/GOTHIC.TTF",30)
score = 100
...
while done==False:
    ...
    #Drawing text on the screen. Blit is the 'stamp' command
